  ...
  <!-- Step 01 -->
    <div id="step01">
      <div class="row">
        ...
        <div class="row">
          <div class="col-4">
            <jsonExcel style="margin-left: 83%;" class="btn btn-outline-primary btn-sm mx-1"  name="ReporteRegistrados.csv" type="csv" :fetch="fetchDataGuests">Reporte de registrados</jsonExcel>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-12 mb-3 px-3">
            <label for="firstName">Mensaje de registro al evento (*u para indicar el nombre del usuario, *c la contraseña del usuario si hay una contraseña genérica y *e para el evento )</label><span class="copys">Max 3000 carácteres</span>
          ...
          <div class="col-md-12 mb-3 px-3">
            ...
            <input readonly type="text" v-model="formEvent.password" class="form-control border-input" cols="30" rows="3"/>
          </div>
        ...
        <div class="row">
         ...
         <div class="row px-3">
          ...
          <div class="col-6 offset-6 mt-1 mb-4">
            <button class='btn btn-outline-primary mt-1 float-right ml-1' @click.prevent="showHabeasData" type="button">habeas Data</button>
            <button class='btn btn-outline-primary mt-1 float-right' @click.prevent="showRegisterEvent" type="button">Formulario de registro</button>
          </div>
        </div>
        ...
        <div class="row px-3">
          ...
          <div class="col-5 offset-7">
            <div class="input-group">
              <input v-model.trim="searchActivity" placeholder="Buscar actividad" @keyup.enter="getActivities" type="text" class="form-control" name="searchTable" />
              <span class="input-group-btn">
                <button class="btn btn-default m-0" @click.prevent="getActivities"><span class="ti-search"></span></button>
              </span>
            </div>
          </div>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr v-for="activity in activities" :key="activity.id">
                  ...
                  <td class="text-right">
                    <button type="button" @click="showActivityMetrics(activity.id)" class="btn btn-outline-primary btn-sm mx-1">
  ...
  <div id="step05">
        ...
        <div class="row px-3">
          ...
          <div class="col-3 offset-9 pt-0" v-if="listQuestions.length > 0">
            <jsonExcel class="btn btn-default w-100 mt-1"  name="Encuesta" :fetch="fetchData">Descargar resultados</jsonExcel>
          </div>
...
export default {
    name: 'MyComponent',
    props:['eventId'],
    components:{ multiselect, editPoll, invitations, registerEvent, habeasData, certificate, jsonExcel, sticker, SlidingPagination, 'editor': Editor},
    data(){
      return{
        eventTypes:[],
        currentPage:1,
