      ...
      <div id="step01" v-if="steps.step1">
        ...
        <div class="row">
          ...
          <div class="col-md-12 mb-3 px-3">
            ...
            <textarea maxlength="800" v-model="formEvent.description" class="form-control border-input" name="" id=""
          ...
          <div class="col-md-12 mb-3 px-3">
            <label for="firstName">Email de confirmación registro al evento (*u para indicar el nombre del usuario, *c
              la contraseña del usuario si hay una contraseña genérica y *e para el evento )</label> <span
              class="copys">Max 3000 carácteres</span>
        ...
        <div class="row">
          ...
          <div class="col-12 pl-6">
            ...
            <button v-if="steps.step2" style="margin-left:4px;" class='btn' @click.prevent="showRegisterEvent"
                    type="button">Formulario de registro
            </button>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="col-md-12 mb-3">
                  ...
                  <div class="custom-file">
                    <input type="file" @change="onFileChange" class="custom-file-input" id="imageEvento"
                           accept="image/*">
              ...
              <div class="col-md-5">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <input type="color" class="form-control border-input" id="firstName" placeholder="" value=""
                         required="">
                </div>
        ...
        <div class="row" v-if="showBtnCreate">
          ...
          <div class="col-md-3">
            <button
                @click="createEvent()"
                type="button"
                class="btn btn-outline-primary btn-block">Crear evento
            </button>
          </div>
        </div>
      </div>
      ...
      <div id="step02" v-if="steps.step2">
        ...
        <div class="row px-3">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" v-model="formActivity.name" class="form-control" id="firstName" placeholder="" value=""
                   required="">
          ...
          <div class="col-md-3 mb-3">
            ...
            <select v-model="formActivity.type_activity_id" class="custom-select d-block w-100" id="country"
                    required="">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="date" v-model="formActivity.start_date" class="form-control" id="firstName" placeholder=""
                   value="" required="">
          ...
          <div class="col-md-3 mb-3">
            <label for="firstName">Hora Inicio</label>
            <input type="time" v-model="formActivity.start_hour" class="form-control" id="firstName" placeholder=""
                   value="" required="">
          ...
          <div class="col-md-3 mb-3">
            <label for="firstName">Hora Fin</label>
            <input type="time" v-model="formActivity.end_hour" class="form-control" id="firstName" placeholder=""
                   value="" required="">
          ...
          <div class="col-md-3 mb-3" v-if="formActivity.type_activity_id == 2">
            ...
            <input type="text" v-model="formActivity.unit_price" class="form-control" id="firstName" placeholder=""
                   value="" required="">
          ...
          <div class="col-md-3 mb-3">
            ...
            <input type="text" v-model="formActivity.guests_limit" class="form-control" id="firstName" placeholder=""
                   value="" required="">
          </div>
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="custom-file">
              <input type="file" name="banner" @change="picActivity" class="custom-file-input" id="actBanner"
                     accept="image/*">
          ...
          <div class="col-md-3 mb-3">
            ...
            <div class="custom-file">
              <input type="file" name="background" @change="picActivity" class="custom-file-input" id="actBg"
                     accept="image/*">
          ...
          <div class="col-md-12 mb-3">
            ...
            <textarea name="" v-model="formActivity.sort_description" class="form-control" id="" cols="30"
                      rows="3"></textarea>
          ...
          <div class="col-md-12 mb-3">
            ...
            <textarea name="" v-model="formActivity.code_streaming" class="form-control" id="" cols="30"
                      rows="2"></textarea>
          </div>
      ...
      <div id="step03" v-if="steps.step2">
        ...
        <div class="row px-3">
          ...
          <div v-if="showSpeaker" class="col-md-8 mb-3">
            ...
            <input type="text" v-model="formSpeaker.name" class="form-control" id="firstName" placeholder="" value=""
                   required="">
        ...
        <div class="row">
          <div class="col-md-2 md-3" v-if="showSpeaker == false && showBtnsAct==true">
            <button
                ...
                type="button"
                class="btn btn-outline-primary btn-block">Crear invitaciones
            </button>
          </div>
          <div class="col-md-2 md-3" v-if="showSpeaker == false && showBtnsAct==true">
            <button
                ...
                type="button"
                class="btn btn-outline-primary btn-block">Adjuntar material
            </button>
          </div>
          <div class="col-md-4 md-3 ml-auto" v-if="showSpeaker == false">
            <button
                ...
                type="button"
                class="btn btn-outline-primary btn-block">Crear actividad
            </button>
          </div>
        </div>
          ...
          <div class="col-md-9">
            ...
            <div v-if="showSpeaker" class="col-md-4">
              <button @click.prevent="createSpeaker()"
                      type="button"
                      class="btn btn-outline-primary ">Crear Speaker
              </button>
            </div>
          </div>
        </div>
