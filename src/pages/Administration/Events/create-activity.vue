      ...
      <div>
        ...
        <div class="row px-3" v-if="showFormActivity">
          ...
          <div class="col-6 text-right">
            <router-link :to="{name:'Editar Evento', params: {eventId:eventId} }" v-if="roleName != 'guest'">
          ...
          <div class="col-md-6 mb-3" v-if="formActivity.mode_id==1 || formActivity.mode_id==3">
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="custom-file">
              <input type="file" @change="picActivity" class="custom-file-input" id="bannerActivity" accept="image/*">
          ...
          <div class="col-md-6 mb-3">
            ...
            <div class="custom-file">
              <input type="file" @change="picActivity" class="custom-file-input" id="backActivity" accept="image/*">
          ...
          <div class="col-md-6 mr-3 px-3" v-if="show_person_number">
            <label for="">Número maximo de personas</label>
            <input type="number" v-model="formEvent.person_numbers" class="form-control border-input" required>
          </div>
          <div class="col-12 pl-3 ml-3">
            <div class="row">
              <div class="col-6 pl-2">
                <input type="checkbox" v-model="formActivity.voice_participation_check" class="form-check-input"
                       id="voice_participation_check">
      ...
      <div>
        <div class="row px-3">
          ...
          <div v-if="showSpeaker" class="col-md-6 mb-3">
            ...
            <input maxlength="50" type="text" v-model="formSpeaker.name" class="form-control" id="firstName"
        ...
        <div class="col-md-12" v-if="showBtnAct">
          <button type="button" class="btn btn-primary btn-invitaciones"
                  @click="createActivity">Crear actividad
          </button>
        </div>
        <br>
      </div>
      <!-- Speaker -->
      <probe :activity_id="model.id" v-if="model.id"/>
      <documents v-if="model.id" :showForm="true" :model="model"></documents>
      <div class="col-6 text-right">
        <router-link :to="{name:'Editar Evento', params: {eventId:eventId} }" v-if="roleName != 'guest'">
          <button type="button" class="btn btn-outline-primary btn-sm mx-1">
            <span class="ti-arrow-left"></span>
...
export default {
  name: 'MyComponent',
  props: ['eventId'],
  components: {multiselect, documents, probe},
  data() {
    return {
      countriesEvent: [],
      countrieSelect: null,
  ...
  methods: {
    ...
    createActivity() {
      ...
      if (this.formActivity.onDemand != true) {
        if (date_start < this.eventStart || date_end > this.eventEnd) {
          this.$swal({
            icon: 'error',
            text: `Las fechas no corresponden a las del evento. El evento inicia: ${this.eventStart} Finaliza:${this.eventEnd}`
          })
          return
        }
      ...
      if (this.formActivity.mode_id != 1 && this.formActivity.mode_id != 3) {
        this.formActivity.guests_limit = -1
      }
      let data = new FormData()
      ...
      this.showBtnAct = false
      axios.post('activities', data).then(response => {
