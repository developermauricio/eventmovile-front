        ...
        <form class="box-login" action="#" v-if="true">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text"  class="form-control border-input border-input" id="firstName" placeholder="" value="" required="">
                <div class="hasError" v-if="false">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-6 mb-3">
                <label for="firstName">Apellido</label>
                <input type="text"  class="form-control border-input border-input" id="lastName" placeholder="" value="" required="">
                <div class="hasError" v-if="false">
                  Valid first name is required.
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text"  class="form-control border-input border-input" id="phone" placeholder="" value="" required="">
                <div class="hasError" v-if="false">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-6 mb-3">
                ...
                <input type="text"  class="form-control border-input border-input" id="email" placeholder="" value="" required="">
                <div class="hasError" v-if="false">
                  Valid first name is required.
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 mb-3">
                ...
                <input type="text"  class="form-control border-input border-input" id="password" placeholder="" value="" required="">
                <div class="hasError" v-if="false">
                  Valid first name is required.
                </div>
              </div>
            ...
            <button class="btn btn-primary btn-block" @click="onSubmit">Registrarme</button>
...
export default {
  ...
  methods:{
    onSubmit(){
      axios.post('auth/basic', this.form).then(response=>{
